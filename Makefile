...
CXX= g++
CXXFLAGS=$(CXX_OPT) $(SANITIZE) -Wall -Wextra -Wpedantic -std=c++11 -I/usr/local/include/bullet -I/usr/include/freetype2 -I/usr/include/SDL2 #-I../../../lib/imgui

LINKER=g++ $(LD_OPT) $(SANITIZE) -o
